...
<head>
  <title>BlueSky - Contact Us</title>
...
<body>
  <div id="main">
    <div id="header">
      <div id="logo">
        <div id="logo_text">
          ...
          <h2>Life is a journey, travel it well.</h2>
        </div>
      </div>
      <div id="menubar">
        <ul id="menu">
    ...
    <div id="site_content">
      ...
      <div id="content">
        <h1>Contact Us</h1>
        <p>Have a question? Fill out the form below and one of our support representatives will send a response in 24 hours.</p>
        <form action="contact_server.php" method="post">
          <div class="form_settings">
            ...
            <p><span>Email Address</span><input type="email" name="email" required>
